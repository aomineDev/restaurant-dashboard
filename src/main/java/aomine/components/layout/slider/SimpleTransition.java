package aomine.components.layout.slider;
...
public class SimpleTransition {
  ...
  public static SliderTransition getShowSidebarTransition(int drawerWidth) {
    return new SliderTransition() {
      @Override
      public void renderImageOld(Component component, Graphics g, Image image, int width, int height, float animate) {
  ...
  public static SliderTransition getHideSidebarTransition(int drawerWidth) {
    return new SliderTransition() {
      @Override
      public void renderImageOld(Component component, Graphics g, Image image, int width, int height, float animate) {
        if (animate != 1) {
  ...
  public static SliderTransition getSwitchViewTransition(Image oldFormImage, int drawerWidth) {
    return new SliderTransition() {
      @Override
      public void renderImageOld(Component component, Graphics g, Image image, int width, int height, float animate) {
        g.drawImage(image, 0, 0, null);
